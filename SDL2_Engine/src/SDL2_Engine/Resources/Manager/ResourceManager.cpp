...
#include "../Resource Types/Custom Resources/Cursor_Container.hpp"
...
namespace SDL2_Engine {
	namespace Resources {
		...
		*/
		void Resources::loadResource(std::shared_ptr<ResourceBase> pResource) {
			...
			case EResourceType::Texture: {
				...
				__SDL2Resource<Texture>* res = (__SDL2Resource<Texture>*)pResource.get();
			...
			case EResourceType::SFX: {
				...
				__SDL2Resource<SFX>* res = (__SDL2Resource<SFX>*)pResource.get();
			...
			case EResourceType::Music: {
				...
				__SDL2Resource<Music>* res = (__SDL2Resource<Music>*)pResource.get();
			...
			case EResourceType::Cursor: {
				...
				__SDL2Resource<Cursor>* res = (__SDL2Resource<Cursor>*)pResource.get();
				...
				Custom_Resources::Cursor_Container* cursor = new Custom_Resources::Cursor_Container();
			...
			case EResourceType::Generic: {
				...
				__SDL2Resource<Generic>* res = (__SDL2Resource<Generic>*)pResource.get();
